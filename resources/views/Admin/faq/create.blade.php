    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Dashboard/faq/Create</li>
                @if($errors->any())
                <div >
                    <ul>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('admin.faq.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName" name="question" aria-describedby="" placeholder="Enter Title">
                        </div>
                        <div class="form-group">
